...
def friends_view(request):
    ...
    received_pending = FriendRequest.objects.filter(to_user=request.user, status='pending')
    sent_pending = FriendRequest.objects.filter(from_user=request.user, status='pending')
